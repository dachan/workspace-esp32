...
- Firmware: flashed image is `ai-model-control/ESP32_MINI-128_tft_240x240-AI_Model_Control-New` from commit `6a0f239`; display order RST/CS/DC/SDA/SCL -> GPIO8/9/10/11/12, Model encoder direction `-1`, readable display rotation `180` degrees, and 50 ms panel/bridge/picker/key timing.
- Mac USB serial: `/dev/cu.usbmodem21201` (re-verify after replug; macOS may renumber native USB CDC ports)
- Last verified: 2026-09-15 — application-only reflash from commit `6a0f239` to `/dev/cu.usbmodem21201`, preserving NVS; esptool verified the written application data. Chip matched ESP32-S3 QFN56 rev v0.2 with embedded 4 MB flash + 2 MB PSRAM, MAC `d4:05:92:47:d5:1c`. Firmware SHA-256 `a836a3fd89dc9a387f5bd4ad7f81f5a3840279e7178b4ba4146d904fe391e36b`. Post-reset serial reported app version `6a0f239`, completed the PSRAM memory test, and repeatedly announced READY until the restarted Model Dial bridge sent SYNC.
