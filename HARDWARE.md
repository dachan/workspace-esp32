...
- Displays: Estardyn 1.3-inch 240x240 SPI TFT (pictured ST7789, 7-pin `BLK/DC/RES/SDA/SCK/VCC/GND`) running the pastel fluid-motion rainbow screensaver, plus 0.96-inch 128x64 I2C SSD1306 OLED with centered date/time
...
- Last verified: 2026-09-14 — chip, 16 MB flash, and 8 MB PSRAM matched MAC `7c:4f:ad:ba:c8:98`; bootloader, partition table, and application from commit `69cdf35` each passed independent esptool verification. Post-reset serial log reported `ST7789 240x240 ready`, `SSD1306 128x64 ready` at `0x3C`, and the joystick-enabled date/time task; application SHA-256 `fd94b05617869b64af4beaf3954a6c10694b11b57fe37933703ae8fba7e78c9a`. The pastel fluid motion still needs desk-side visual confirmation.
