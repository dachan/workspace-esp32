...
- Last verified: 2026-09-10 — application-only reflash, hash-verified, preserving NVS and the **v0.90** version. Model Dial now owns ChatGPT effort and Cursor model enable lists; the panel has no on-device MODELS settings screen. Build from commit `d49519c`; firmware SHA-256 `52b01bce0fdf762626c6184d0df069e1e454534e8bc40539dbeebf7911d5406f`. Board identity matched the recorded ESP32-S3. Bridge launched with the configured masks; live serial received READY, ENABLED, and both STATE fields after reconnect. Physical touch behavior was not rechecked; the documented model-knob wiring fault remains unresolved.
