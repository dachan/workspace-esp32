...
- Last verified: 2026-09-10 — application-only reflash, hash-verified, preserving NVS and the **v0.90** version. Touch release now debounces 150 ms to prevent false SYNC pushes; the rebuilt bridge clears queued serial input before SYNC. Build from commit `f88cfb5`; firmware SHA-256 `e4cfd41888ef8833c0db6842a415be4648b274209324f8c35bb43547eaa1f37e`. Board identity matched the recorded ESP32-S3. Live serial received ENABLED plus both STATE fields and applied once on reconnect; no unsolicited PUSH arrived during a 12-second quiet observation. Physical touch behavior was not rechecked; the documented model-knob wiring fault remains unresolved.
