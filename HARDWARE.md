...
- Last verified: 2026-09-14 — chip, 16 MB flash, and 8 MB PSRAM matched MAC `7c:4f:ad:ba:c8:98`; bootloader, partition table, and application from commit `9c7d54c` each passed independent esptool verification. Post-reset serial log reported `ST7789 240x240 ready`, `SSD1306 128x64 ready` at `0x3C`, and the joystick-enabled date/time task; application SHA-256 `d5bbaff9db8ada117f2f14789f29d3ba020714f88c59a15aaa56f3fe87994cf6`. The pastel motion, Gaussian blur, and FPS overlay still need desk-side visual confirmation.
