...
- Last verified: 2026-09-23 — application-only reflash of the New SuperMini v0.90 from commit `fd35b98`, preserving NVS. Live MAC/chip matched the inventory (4 MB flash / 2 MB PSRAM); esptool write verification and independent digest verification passed. Firmware SHA-256 `38d839793545b902f8da3ed70213ea8b4bc3567daefdd569f82ab56fcbac37a3`; boot reached `READY c85a87d1705b69e4`. Live serial confirmed `CONFIG CHATGPT_OLDER 1` permits GPT-5.6 Terra and `0` clamps it to GPT-6 Astra, without APPLY/PUSH. Signed Model Dial relaunched with older models disabled and Cursor mask `00000020000044d1`. Settings now offers Show older models in a content-sized non-scrolling window. Physical panel appearance remains unverified. Rig order and dial wiring are unchanged.
