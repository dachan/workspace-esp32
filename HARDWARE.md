...
- Last verified: 2026-09-21 — application-only reflash of `ESP32_MINI-128_tft_240x240-AI_Model_Control-New` v0.90 to `/dev/cu.usbmodem21201`, preserving NVS; esptool verified the write and an independent readback. Chip matched ESP32-S3 QFN56 rev v0.2 with embedded 4 MB flash + 2 MB PSRAM, MAC `d4:05:92:47:d5:1c`. Firmware from commit `eee129c` has SHA-256 `6e446a06ba0e38a2a2fe500a92f0197684152cd97c099c6ce8a3d93ece280d1b`; its boot log reached `READY`. The signed Model Dial bridge reconnected with Cursor mask `00000020000044d1`, including Grok 4.7. Physical panel appearance remains unverified. Rig models walk A–Z by the full provider-plus-name label. Default knobs are left = model (GPIO4/5/6) and right = effort (GPIO1/2/7); Settings → Dials can swap them.
