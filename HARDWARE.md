...
- Last verified: 2026-09-20 — application-only reflash of `ESP32_MINI-128_tft_240x240-AI_Model_Control-New` v0.90 to `/dev/cu.usbmodem21201`, preserving NVS; esptool verified the written application data. Chip matched ESP32-S3 QFN56 rev v0.2 with embedded 4 MB flash + 2 MB PSRAM, MAC `d4:05:92:47:d5:1c`. Firmware SHA-256 `3b534a082ea39a7d35ebd8774540fde406713f3e540f3681c538a2696be2f43b`. Rig models walk A–Z by the full provider-plus-name label. Default knobs are left = model (GPIO4/5/6) and right = effort (GPIO1/2/7); Settings → Dials can swap them.
