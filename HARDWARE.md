...
- Last verified: 2026-09-23 — application-only reflash of `ESP32_MINI-128_tft_240x240-AI_Model_Control-New` v0.90 to `/dev/cu.usbmodem21201`, preserving NVS; esptool verified the write and an independent readback matched. Chip matched ESP32-S3 QFN56 rev v0.2 with embedded 4 MB flash + 2 MB PSRAM, MAC `d4:05:92:47:d5:1c`. Firmware from commit `23a65f2` has SHA-256 `bef4f922e0307a105d9a59be13ccb9dd02e7bb5842fa1b5ac088bf6c36c7deee`; its boot log reached `READY 886b8a41ca447901`. The signed Model Dial bridge reconnected and received `READY` plus Cursor mask `00000020000044d1`, including Grok 4.7. Physical panel appearance remains unverified. Rig models walk Z–A by the full provider-plus-name label. Default knobs are left = model (GPIO4/5/6) and right = effort (GPIO1/2/7); Settings → Dials can swap them.
