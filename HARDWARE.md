...
- Last verified: 2026-09-18 — application-only reflash of `ESP32_MINI-128_tft_240x240-AI_Model_Control-New` v0.90 to `/dev/cu.usbmodem21201`, preserving NVS; esptool verified the written application data. Chip matched ESP32-S3 QFN56 rev v0.2 with embedded 4 MB flash + 2 MB PSRAM, MAC `d4:05:92:47:d5:1c`. Firmware SHA-256 `0779ff0d9e8143a7d78cc2d88b7d47555fe057c7e25ec063a6e0d95ae58f5c1a`. After reset it announced `READY f24a5cb8ed33ea62`. This image uses a Rig Latest-alias encoder catalog (`Grok Latest`, GPT/Claude/Gemini/DeepSeek/Kimi Latest names, Auto–Max thinking). Focusing Rig sends `FRONT Rig` plus host `MODEL`/`THINKING` from `agent.focus`.
