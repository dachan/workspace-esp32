...
- Last verified: 2026-09-23 — application-only reflash of the New SuperMini v0.90 from commit `086a789`, preserving NVS. Live ESP32-S3 MAC `d4:05:92:47:d5:1c`, 4 MB flash and 2 MB PSRAM matched inventory on `/dev/cu.usbmodem21201`; esptool write verification and independent digest verification passed. Firmware SHA-256 `6b44ce9204c8b0ded7e57285e582b3c816fc18506353d97992353a6b6ed93ac4`. The stable-signed Model Dial app was installed and relaunched; its bridge reconnected, received panel state and Cursor mask `00000020000044d1`, and read the seven picker-visible models: GPT-6 Astra/Sol/Luna, GPT-5.6 Sol/Terra/Luna, and GPT-5.5. The bridge sends this ordered ChatGPT catalog and per-model effort masks to the panel, refreshing every 10 seconds. Physical panel appearance and the target app's selected model were not visually checked.
