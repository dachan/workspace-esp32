...
- Last verified: 2026-09-15 — application-only reflash to `/dev/cu.usbmodem21201`, preserving NVS; esptool verified the written application data. Chip matched ESP32-S3 QFN56 rev v0.2 with embedded 4 MB flash + 2 MB PSRAM, MAC `d4:05:92:47:d5:1c`. The build's Model Dial sources match main commit `181f95f` (project build stamp `d177fca`); firmware SHA-256 `e10ba14a8646e5037fc8f7b9e09eeccb6df02bb01589fafa82ed676e2e28c556`. After reset it repeatedly announced READY boot id `c76b04deb85a2257` for 12 seconds without a watchdog reset. The restored Model Dial bridge completed SYNC and received MODEL/THINKING state. Physical clock rendering and disabled-control behavior still need desk-side observation.
