...
- Last verified: 2026-09-23 — application-only reflash of the New SuperMini v0.90 from commit `eaf861d`, preserving NVS. Live ESP32-S3 MAC `d4:05:92:47:d5:1c`, 4 MB flash and 2 MB PSRAM matched inventory on `/dev/cu.usbmodem21201`; esptool write verification and independent digest verification passed. Firmware SHA-256 `95f30f9ae8b482dcce34a88fb9cc3b6f26f2192192801bcebe095797d871ac47`. The stable-signed Model Dial app was installed and relaunched; its bridge reconnected, received the panel state and Cursor mask `00000020000044d1`, and read the computer's visible Codex catalog as GPT-6 Astra, Sol, and Luna. The bridge now sends ordered ChatGPT model names and per-model effort masks to the panel, refreshing every 60 seconds. Physical panel appearance and the target app's selected model were not visually checked.
