...
- Last verified: 2026-09-23 — application-only reflash of `ESP32_MINI-128_tft_240x240-AI_Model_Control-New` v0.90 to `/dev/cu.usbmodem21201`, preserving NVS; esptool verified the write and an independent readback matched. Chip matched ESP32-S3 QFN56 rev v0.2 with embedded 4 MB flash + 2 MB PSRAM, MAC `d4:05:92:47:d5:1c`. Firmware from commit `0bf9b90` has SHA-256 `5f428d6f20301c134a5b1c9eaaf59da56af43b2ed0b09281c26bd585afcba8f5`; its boot log reached `READY 0a1994f6e0fe7513`. The signed Model Dial bridge is ready to reconnect with Cursor mask `00000020000044d1`, including Grok 4.7. Physical panel appearance remains unverified. Rig models walk Z–A by the full provider-plus-name label. Default knobs are left = model (GPIO4/5/6) and right = effort (GPIO1/2/7); Settings → Dials can swap them.
